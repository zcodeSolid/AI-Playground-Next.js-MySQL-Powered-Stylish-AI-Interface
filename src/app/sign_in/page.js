...
export default function SignInPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(JSON.stringify({ inputValue, passwordValue }))
        ...
        <div className="ad066d2e">
          <div className="ds-theme" style={{ "--ds-rgb-hover": "245 245 245", "--ds-rgb-primary": "77 107 254", "--ds-button-hover-color": "#2563EB", fontSize: "var(--ds-font-size-m)", lineHeight: "var(--ds-line-height-m)" }}>
            <div className="ds-auth-form-wrapper">
              ...
              <div className="ds-sign-up-form__tips">Only login via email, Google, Facebook login is supported in your region.</div>
              ...
              <div className="ds-sign-in-form__form-footer">
                ...
                <div role="button" className="ds-button ds-button--primary ds-button--text ds-button--rect ds-button--m" tabIndex="0">Sign up</div>
              </div>
